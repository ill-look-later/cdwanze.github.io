...
\begin{document}
\usetikzlibrary{backgrounds,calc}
\begin{tikzpicture}[background rectangle/.style={fill=blue!70},show background rectangle,scale=0.3]
  % Create some counters for holding the Fibonacci numbers
  \newcounter{a}
  \newcounter{b}
  \newcounter{temp}

\node[scale=3]{\Huge Wise};
...
% Initialize the counters
  ...
  \foreach \i in {1,...,18}
  {
    ...
    \draw[color=white,line width=0.5ex] (\lastpoint) arc 
